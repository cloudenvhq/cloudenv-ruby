Gem::Specification.new do |s|
  ...
  s.files = ["install.rb", "lib", "lib/cloud-env.rb", "LICENSE", "Rakefile", "README.markdown", "cloud-env.gemspec", "test", "test/base", "test/base/base_test.rb", "test/data", "test/test_helper.rb"]
  s.rubyforge_project = "cloud-env"
